  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        medical: "bg-primary text-primary-foreground shadow-medium hover:bg-primary-hover hover:shadow-strong transform hover:-translate-y-0.5 transition-all duration-200",
        hero: "hero-gradient text-white shadow-strong hover:shadow-strong hover:scale-105 transform transition-all duration-300 border-0",
        success: "bg-success text-success-foreground shadow hover:bg-success/90",
        professional: "bg-card text-card-foreground border border-border shadow-soft hover:shadow-medium transition-all duration-200",
      },
      size: {
